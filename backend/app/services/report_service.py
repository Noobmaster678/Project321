...
def _matches_individual(individual_id: str):
    return (
...
async def generate_summary_report(
    ...
    if individual_id:
        det_query = det_query.where(_matches_individual(individual_id))
    ...
    if individual_id:
        sp_q = sp_q.where(_matches_individual(individual_id))
    ...
    if individual_id:
        conf_q = conf_q.where(_matches_individual(individual_id))
    ...
    if individual_id:
        cam_q = cam_q.where(_matches_individual(individual_id))
    ...
    if individual_id:
        hourly_q = hourly_q.where(_matches_individual(individual_id))
    ...
    if individual_id:
        month_q = month_q.where(_matches_individual(individual_id))
    ...
    if individual_id:
        recent_q = recent_q.where(_matches_individual(individual_id))
    ...
    if total_trap_nights_val > 0:
        ...
        if individual_id:
            event_species_q = event_species_q.where(_matches_individual(individual_id))
